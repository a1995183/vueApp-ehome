<template>
 <div class="home">
   ...
   <div class="center-menu">
     <div @click="newsList('0','信工新闻眼')" class="menu-item">
   ...
   <div style="height:110px"></div>
     <div @click="newsList('3','党建一点通')" class="menu-item">
       <img class="icon-img" src="../../img/home/icon_04.png">
       <p class="icon-text">党建一点通</p>
     </div>
     <div @click="newsList('5','党员亮身份')" class="menu-item">
...
import { swiper, swiperSlide,Loading  } from 'vue-awesome-swiper'
export default {
    components: {
      swiper,
      swiperSlide
